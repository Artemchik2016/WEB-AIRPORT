...
/**
 * Created by Пользователь-ПК on 05.06.2017.
 */
@WebServlet("/add_new_airplanes_row")
public class AddNewRow extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String flight_number =  request.getParameter("flight_number");
        String model = request.getParameter("model");
        int seats_capacity = request.getIntHeader("seats_capacity");
        AirplanesEntity airplanesEntity = new AirplanesEntity(flight_number,model,seats_capacity);
